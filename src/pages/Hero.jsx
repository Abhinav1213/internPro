...
export default function Hero() {
    return (
        <div className="bg-white mb-5" id="Home">
            ...
            {/* Image Section */}
            <div className="flex justify-center items-center px-4 py-8 lg:py-16 bg-gradient-to-r from-blue-50 via-white to-blue-50">
                <img
                    src={Graph}
                    alt="Graph Animation"
                    className="w-full h-auto max-w-3xl lg:max-w-5xl rounded-lg shadow-lg"
                    style={{
                        height: 'auto',
                        maxHeight: '600px',
